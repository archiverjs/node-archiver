 ...
 * https://github.com/ctalkington/node-archive/blob/master/LICENSE-MIT
 */
...
util.inherits(Archive, stream.Stream);

exports.createZip = function(opt) {
  return new Archive(opt);
};
...
Archive.prototype.pause = function() {
  var self = this;
  self.paused = true;
};

Archive.prototype.resume = function() {
  var self = this;
  self.paused = false;
...
Archive.prototype._read = function() {
  var self = this;
...
Archive.prototype.finalize = function(callback) {
  var self = this;
...
Archive.prototype._addFileStore = function(source, file, callback) {
  // placeholder
};

Archive.prototype._addFileDeflate = function(source, file, callback) {
  // placeholder
};

Archive.prototype.addFile = function(source, file, callback) {
  var self = this;
...
// local file header
Archive.prototype._pushLocalFileHeader = function(file) {
  var self = this;
...
Archive.prototype._pushDataDescriptor = function(file) {
  var self = this;
...
Archive.prototype._pushCentralDirectory = function() {
  var self = this;
