...
Archiver.prototype._onQueueDrain = function() {
  ...
  if (this._state.finalize && this._queue.idle()) {
...
Archiver.prototype.abort = function() {
  if (this._state.aborted) {
    this.emit('error', new Error('unable to abort: already aborted'));
    return this;
  }

  if (this._state.finalized) {
    this.emit('error', new Error('unable to abort: already finalized'));
    return this;
  }
...
Archiver.prototype.append = function(source, data) {
  if (this._state.finalize || this._state.aborted) {
    this.emit('error', new Error('unable to append: queue closed'));
    return this;
  }
...
Archiver.prototype.bulk = function(mappings) {
  if (this._state.finalize || this._state.aborted) {
    this.emit('error', new Error('unable to bulk append: queue closed'));
    return this;
  }
...
Archiver.prototype.file = function(filepath, data) {
  if (this._state.finalize || this._state.aborted) {
    this.emit('error', new Error('unable to append file: queue closed'));
    return this;
  }
...
Archiver.prototype.finalize = function() {
  if (this._state.aborted) {
    this.emit('error', new Error('unable to finalize: archive was aborted'));
    return this;
  }

  if (this._state.finalize) {
    this.emit('error', new Error('unable to finalize: archive already finalizing'));
    return this;
  }
...
Archiver.prototype.setModule = function(module) {
  if (this._state.aborted) {
    this.emit('error', new Error('archive process was previously aborted'));
    return this;
  }

  if (this._state.modulePiped) {
    this.emit('error', new Error('format module has already been set'));
    return;
  }
