...
Archiver.prototype.append = function(source, data) {
  ...
  if (typeof data.name !== 'string' || data.name.length === 0) {
    this.emit('error', new ArchiverError('ENTRYNAMEREQUIRED', { name: data.name }));
    return this;
  }
  ...
  if (Buffer.isBuffer(source)) {
    ...
    this.emit('error', new ArchiverError('INPUTSTEAMBUFFER', { name: data.name }));
    return this;
  }
...
Archiver.prototype.directory = function(dirpath, destpath, data) {
  ...
  if (typeof dirpath !== 'string' || dirpath.length === 0) {
    this.emit('error', new ArchiverError('DIRECTORYDIRPATHREQUIRED', { dirpath: dirpath }));
    return this;
  }
...
Archiver.prototype.file = function(filepath, data) {
  ...
  if (typeof filepath !== 'string' || filepath.length === 0) {
    this.emit('error', new ArchiverError('FILEFILEPATHREQUIRED', { filepath: filepath }));
    return this;
  }
...
Archiver.prototype.symlink = function(filepath, target) {
  ...
  if (!this._moduleSupports('symlink')) {
    this.emit('error', new ArchiverError('SYMLINKNOTSUPPORTED', { filepath: filepath, target: target }));
    return this;
  }

  if (typeof filepath !== 'string' || filepath.length === 0) {
    this.emit('error', new ArchiverError('SYMLINKFILEPATHREQUIRED', { filepath: filepath, target: target }));
    return this;
  }

  if (typeof target !== 'string' || target.length === 0) {
    this.emit('error', new ArchiverError('SYMLINKTARGETREQUIRED', { filepath: filepath, target: target }));
    return this;
  }
