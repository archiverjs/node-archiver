...
/**
 * Determines if the current modules supports a defined feature.
 *
 * @private
 * @param  {string} key
 * @return {boolean}
...
/**
 * Tracks the length of this archive.
 *
 * @private
 * @param  {Buffer}   chunk
...
/**
 * [_updateQueueTaskWithStats description]
 *
 * @private
 * @param  {Object} task
 * @param  {fs.Stats} stats
